...
Revision ID: 2f24e1bea97c
Revises: 
Create Date: 2024-06-25 19:11:54.448785
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_value_id', name='uq_product_attribute_value')
    )
    ...
    sa.CheckConstraint('LENGTH(alternative_text) > 0', name='product_image_alt_length'),
    sa.CheckConstraint('LENGTH(url) > 0', name='product_image_url_length'),
    sa.ForeignKeyConstraint(['product_line_id'], ['product_line.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('alternative_text', name='uq_product_image_alt')
    )
